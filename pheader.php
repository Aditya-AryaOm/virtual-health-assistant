                    ...
                    <div class="navbar-custom-menu">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown dropdown-user admin-user">
                                ...
                                <img src="assets/admin_page/dist/img/mini-logo.png" class="img-circle" height="40" width="40" alt="User Image">
                                </div>
                                </a>
                ...
                <div class="sidebar">
                    ...
                    <div class="user-panel">
                        <div class="image pull-left">
                            <img src="assets/admin_page/dist/img/avatar2.png" class="img-circle" alt="User Image">
                        </div>
                        <div class="info">
                            <h4>Welcome</h4>
                    ...
                    <ul class="sidebar-menu">
                        <li>
                            <a href="dailySchedule.php"><i class="fa fa-hospital-o"></i><span>Daily Schedule</span>
                            </a>
                        </li>
                        <li>
